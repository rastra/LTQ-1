...
(function ($) {
    ...
    $.fn.jquizzy = function (settings) {
        ...
        var defaults = {
            questions: null,
            twitterStatus: 'Horee.,I get scored {score} on this awesome quiz! http://ltq.zz.mu',
            startText: '',
            endText: 'Finished!',
        ...
        var superContainer = $(this),
            ...
            exitFob = '<div class="results-container slide-container"><div class="question-number">' + config.endText + '</div><div class="result-keeper"></div></div align = "center"><div class="notice" >Silahkan pilih jawaban terlebih dahulu</div><div class="progress-keeper" ><div class="progress"></div></div>',
            contentFob = '';
        ...
        superContainer.find('.final').click(function () {
            ...
            for (var i = 0, toLoopTill = results.length; i < toLoopTill; i++) {
                ...
                resultSet += '<div class="result-row"> Soal ke-' + (i + 1) + (results[i] === true ? "<div class='correct'><span>Benar</span></div>" : "<div class='wrong'><span>Salah</span></div>");
            ...
            shareButton = '<a href="http://twitter.com/share?text=' + config.twitterStatus.replace("{score}", score) + '&via=LTQ" class="share-button"><img src="' + config.twitterImage + '" /></a>';


            resultSet = '<h2 class="qTitle">' + judgeSkills(score) + ' Kamu mendapat nilai ' + score + '</h2>' + shareButton + resultSet + '<div class="jquizzy-clear"></div>';
